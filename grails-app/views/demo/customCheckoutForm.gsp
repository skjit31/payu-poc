...
<body>
<g:form method="post" name="customerData" controller="demo" action="nonSeamlessRequest">
    ...
    <table width="50%" height="100" border='1' align="center">
        ...
        <tr>
            <td>Merchant Id	:</td><td><input type="text" name="merchant_id" value="${merchantId}"/></td>
        </tr>
        <tr>
        ...
        <tr>
            <td>Redirect URL	:</td><td><input type="text" name="redirect_url" value="${responseUrl}"/></td>
        </tr>
        <tr>
            <td>Cancel URL	:</td><td><input type="text" name="cancel_url" value="${responseUrl}"/></td>
        </tr>
        <tr>
...
<script type="text/javascript">
    $(function(){
         ...
         */
        var jsonData;
        var access_code = "${accessCode}"; // shared by CCAVENUE
        var amount="10.00";
        var currency="INR";
